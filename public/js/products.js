...
function updateVariantPreview() {
    ...
    $(variantPreviewArray).each(function(index, element) {
        tableBody += `<tr>
                        ...
                        <td>
                                        <input type="text" class="form-control" value="" name="product_preview[${index}][price]" required>
                                    </td>
                        <td>
                                        <input type="text" class="form-control" value="" name="product_preview[${index}][stock]">
                                    </td>
                      </tr>`;
    });
